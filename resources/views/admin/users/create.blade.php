<x-app-layout title="Create a new user">
    <x-form method="POST" action="/admin/users" enctype="multipart/form-data"
        ...
        <div class="flex flex-col gap-6 md:gap-10 w-full md:w-1/2">
            ...
            <x-text-input required="true" name="email" id="email" label="Email" :value="old('email', '')"
                placeholder="jane@example.com" />

            <x-text-input required="true" name="password" id="password" label="Password" :value="old('password', '')" />
